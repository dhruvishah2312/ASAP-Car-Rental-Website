...
public class SeleniumTC03 extends ASAP_BusinessFunctions {
	...
	@Test
	public void testSeleniumTC03() throws Exception {
		driver.get(sAppURL);
		...
		driver.findElement(By.name(prop.getProperty("Txt_ASAPCarRental_RegUsername"))).sendKeys("wasiqaliabbasi3");
		...
		A_BF_Login(driver, "wasiqaliabbasi3", "Test@123");
