...
public class SeleniumTC04 extends ASAP_BusinessFunctions {
	...
	@Test
	public void testSeleniumTC04() throws Exception {
		driver.get(sAppURL);
		new Select(driver.findElement(By.id("userType"))).selectByVisibleText("Manager");
		...
		driver.findElement(By.name(prop.getProperty("Txt_ASAPCarRental_RegUsername"))).sendKeys("wasiqaliabbasi4");
		...
		A_BF_Login(driver, "wasiqaliabbasi4", "Test@123");
