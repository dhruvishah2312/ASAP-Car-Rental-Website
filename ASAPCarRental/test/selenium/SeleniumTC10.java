...
public class SeleniumTC10 extends ASAP_BusinessFunctions {
	...
	@Test
	public void testTC4Enddate() throws Exception {
		driver.get(sAppURL);
		...
		try {
			assertEquals("End date cannot be blank", driver.findElement(By.xpath(prop.getProperty("end_Date_cannot_be_blank"))).getAttribute("value"));
		} catch (Error e) {
		...
		driver.findElement(By.id(prop.getProperty("Txt_UserHome_enddate"))).sendKeys("12/11/2018");
		driver.findElement(By.cssSelector(prop.getProperty("Btn_UserHome_Search"))).click();
		try {
			assertEquals("Chosen drop date can't be before Start date", driver.findElement(By.xpath(prop.getProperty("end_Date_cannot_be_blank"))).getAttribute("value"));
		} catch (Error e) {
			verificationErrors.append(e.toString());
		}
		driver.findElement(By.name(prop.getProperty("Txt_UserHome_capacity"))).clear();
		...
		driver.findElement(By.cssSelector(prop.getProperty("Btn_UserHome_Search"))).click();
		try {
			assertEquals("", driver.findElement(By.xpath(prop.getProperty("end_Date_cannot_be_blank"))).getAttribute("value"));
		} catch (Error e) {
			verificationErrors.append(e.toString());
		}
