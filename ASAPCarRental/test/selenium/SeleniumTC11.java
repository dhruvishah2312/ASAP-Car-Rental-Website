...
public class SeleniumTC11 extends ASAP_BusinessFunctions {
	...
	@Test
	public void testTC5Pickup() throws Exception {
		driver.get(sAppURL);
		...
		driver.findElement(By.id(prop.getProperty("Txt_UserHome_startdate"))).sendKeys("");
		driver.findElement(By.cssSelector(prop.getProperty("Btn_UserHome_Search"))).click();
		try {
			assertEquals("Pick-up date is empty", driver.findElement(By.xpath(prop.getProperty("time_start_empty"))).getAttribute("value"));
		} catch (Error e) {
		...
		new Select(driver.findElement(By.name(prop.getProperty("Select_UserHome_pickuptime")))).selectByVisibleText("19:00");
		driver.findElement(By.cssSelector(prop.getProperty("Btn_UserHome_Search"))).click();
		try {
			assertEquals("Saturdays 8am to 5pm", driver.findElement(By.xpath(prop.getProperty("time_start_empty"))).getAttribute("value"));
		} catch (Error e) {
			verificationErrors.append(e.toString());
		}
		driver.findElement(By.name(prop.getProperty("Txt_UserHome_capacity"))).clear();
		...
		driver.findElement(By.id(prop.getProperty("Txt_UserHome_startdate"))).clear();
		driver.findElement(By.id(prop.getProperty("Txt_UserHome_startdate"))).sendKeys("12/16/2018");
		driver.findElement(By.id(prop.getProperty("Txt_UserHome_enddate"))).clear();
		driver.findElement(By.id(prop.getProperty("Txt_UserHome_enddate"))).sendKeys("12/18/2018");
		driver.findElement(By.cssSelector(prop.getProperty("Btn_UserHome_Search"))).click();
		try {
			assertEquals("Sundays 12pm to 5pm", driver.findElement(By.xpath(prop.getProperty("time_start_empty"))).getAttribute("value"));
		} catch (Error e) {
			verificationErrors.append(e.toString());
		}
		driver.findElement(By.name(prop.getProperty("Txt_UserHome_capacity"))).clear();
